...
├── 04-kmeans/
│   ├── README.md              ← K-Means full guide
│   ├── kmeans.ipynb           ← Jupyter notebook with implementation
│   └── Mall_Customers.csv     ← Sample dataset
├── 05-gmm-em/
│   ├── README.md              ← GMM & EM full guide
│   ├── gmm_em.ipynb           ← Jupyter notebook
│   ├── gmm_covariance_comparison.png
│   ├── gmm_k_tuning.png
│   └── gmm_visualizations.png
├── 06-dbscan-hdbscan/
│   ├── README.md              ← DBSCAN & HDBSCAN full guide
│   ├── dbscan_hdbscan.ipynb   ← Jupyter notebook
│   ├── eps_tuning.png
│   ├── hdbscan_outlier_scores.png
│   ├── hdbscan_tuning.png
│   ├── noise_detection.png
│   └── dbscan_hdbscan_comparison.png
└── 07-hierarchical-clustering/
    ├── README.md              ← Hierarchical Clustering full guide
    ├── hierarchical_clustering.ipynb
    ├── agglomerative_flow.svg
    ├── dendrogram_example.svg
    ├── dendrogram.png
    ├── distance_heatmap.png
    ├── hyperparameter_n_clusters.png
    ├── linkage_comparison.png
    ├── linkage_comparison_metrics.png
